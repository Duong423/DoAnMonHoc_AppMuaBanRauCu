package com.example.taphoa.adapters;
...
public class RecommenedeAdapter  extends RecyclerView.Adapter<RecommenedeAdapter.ViewHolder> {
    Context context;
    List<RecommendedModel> list;

    public RecommenedeAdapter(Context context, List<RecommendedModel> list) {
